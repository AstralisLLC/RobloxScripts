...
Keys.Codes = {
    ...
    ["NumpadZero"] = Enum.KeyCode.KeypadZero,
    ["NumpadOne"] = Enum.KeyCode.KeypadOne,
    ["NumpadTwo"] = Enum.KeyCode.KeypadTwo,
    ["NumpadThree"] = Enum.KeyCode.KeypadThree,
    ["NumpadFour"] = Enum.KeyCode.KeypadFour,
    ["NumpadFive"] = Enum.KeyCode.KeypadFive,
    ["NumpadSix"] = Enum.KeyCode.KeypadSix,
    ["NumpadSeven"] = Enum.KeyCode.KeypadSeven,
    ["NumpadEight"] = Enum.KeyCode.KeypadEight,
    ["NumpadNine"] = Enum.KeyCode.KeypadNine,
    ["NumpadPlus"] = Enum.KeyCode.KeypadPlus,
    ["NumpadMinus"] = Enum.KeyCode.KeypadMinus,
    ["NumpadMultiply"] = Enum.KeyCode.KeypadMultiply,
    ["NumpadDivide"] = Enum.KeyCode.KeypadDivide,
    ["NumpadEnter"] = Enum.KeyCode.KeypadEnter,
    ["NumpadPeriod"] = Enum.KeyCode.KeypadPeriod,
    ["F1"] = Enum.KeyCode.F1,
    ["F2"] = Enum.KeyCode.F2,
    ["F3"] = Enum.KeyCode.F3,
    ["F4"] = Enum.KeyCode.F4,
